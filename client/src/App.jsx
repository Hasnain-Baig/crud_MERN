...
function App() {
  ...
  useEffect(() => {
    ...
    Axios.get("https://crud-mern-1.herokuapp.com/apis/users")
      .then((response) => {
  ...
  const addUser = () => {
    ...
    Axios.post("https://crud-mern-1.herokuapp.com/apis/users", newUser)
      .then((response) => {
  ...
  const deleteUser = (id) => {
    ...
    Axios.delete(`https://crud-mern-1.herokuapp.com/apis/users/${id}`)
      .then((response) => {
  ...
  const updateUser = (uUser) => {
    ...
    Axios.put(`https://crud-mern-1.herokuapp.com/apis/users/${uUser._id}`, uUser)
      .then((response) => {
